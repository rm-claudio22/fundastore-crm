...
urlpatterns = [
    ...
    path('Nosotros', nostros, name='nosotros'),
    path('Contactenos', ver_contactenos, name = 'principal-contactenos'),

    path('blog/recetas', recetas, name = 'principal-blog-recetas'),

    path('ListarProductos', listarProductos, name='listarProductos'),
    path('AgregarProductos', agregarProductos,name='agregarProducto'),
    path('EditarProductos/<int:id>', editarProducto, name='editarProducto'),
    path('LeerProductos/<int:id>', leerProducto, name='leerProducto'),
